...
[centerred, radiusred] = imfindcircles(threshedred, 70, 'Sensitivity',1);
[centeryel, radiusyel] = imfindcircles(threshedyellow, 70, 'Sensitivity',1);
x1 = centerred(1,1);
x2 = centeryel(1,1);
y1 = centerred(1,2);
y2 = centeryel(1,2);
...
rgb = insertShape(readimg,'Line', [midpt(1),midpt(2),x2,y2], 'Color', 'blue', 'LineWidth', 8);
imshow(rgb);
